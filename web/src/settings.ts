    ...
    groups: [
      ...
      },
      {
        ...
        settings: [
          ...
          bool('a.animateMessages', 'Animate message entrance', 'Appearance', true),
          bool('a.wideComposer', 'Wide composer on desktop', 'Appearance', false),
          slider('a.toastDuration', 'Toast duration', 'Appearance', 2600, 1000, 8000, 100, 'ms'),
        ],
      },
      {
        name: 'Motion & effects',
    ...
    groups: [
      ...
      },
      {
        ...
        settings: [
          ...
          bool('c.midiQuickGen', 'MIDI quick-generate in Studio', 'Behaviour', true),
          bool('c.showModelBadge', 'Show which AI model answered', 'Behaviour', true),
          select('c.sendBehavior', 'After sending', 'Behaviour', 'stay', [{ value: 'stay', label: 'Stay in chat' }, { value: 'clear-focus', label: 'Clear & refocus composer' }]),
        ],
      },
    ],
  },
