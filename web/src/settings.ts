    ...
    groups: [
      ...
      },
      {
        ...
        settings: [
          ...
          slider('a.blurAmount', 'Background blur', 'Motion & effects', 8, 0, 24, 1, 'px'),
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        name: 'Sounds',
        settings: [
          bool('n.sounds', 'Interface sounds', 'Sounds', false, 'Use quiet interface sounds.'),
          ...
          bool('n.sendSound', 'Play sound on send', 'Sounds', false),
