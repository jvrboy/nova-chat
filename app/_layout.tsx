...
export default function RootLayout() {
  ...
  return <BackendProvider><NovaProvider><StatusBar barStyle="light-content" /><Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: '#07111f' } }} /></NovaProvider></BackendProvider>;
}
